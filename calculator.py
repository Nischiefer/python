...
def button_clicked(value):
    ...
    if value in right_symbols:
                ...
                if operator == "+":
                    ...
                    if value == "√":
                        ...
                        if numA >= 0:
                            ...
                            label["text"] = "Error"
                        return
                clear_all() #after calculation clear A, operator, B for new calculation



        elif value in "÷×-+":       #500 + , * 500 + 100 500 lai a ma save garcha without reseting A
            if operator is None:
                A = label["text"]
                label["text"] = "0"
                B="0"
        ...
        if value == ".":
            ...
            if label["text"] == "0": #05 ko satta 5 display grauna 
                label["text"] = value
            else:
